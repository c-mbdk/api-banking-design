...
class TestCustomerRepository:
    ...
    async def test_create_customer_success(
        ...
        assert new_customer.date_of_birth.strftime("%Y-%m-%d") == valid_customer_data_two[1]["date_of_birth"]  # noqa
    ...
    async def test_customer_exists_by_guid_fail(
        ...
        assert await customer_repo.customer_exists_by_guid(nonexistent_customer_guid) is False  # noqa
